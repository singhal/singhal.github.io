...
## 2024
* Singhal S, C DiVittorio, C Jones, I Ixta, A Widmann, I Giffard‐Mena, F Zapata and AB Roddy. Population structure and natural selection across a flower color polymorphism in the desert plant _Encelia farinosa_. **American Journal of Botany**, 111(10): e16413. ([pdf](/assets/docs/Singhal_etal_farinosa.pdf) and [SI](/assets/docs/Singhal_etal_farinosa_SI.pdf) and [repo](https://github.com/singhal/farinosa))
* Berv JS, S Singhal, DJ Field, N Walker-Hale, SW McHugh, JR Shipley, ET Miller, RT Kimball, EL Braun, A Dornburg, and CT Parins-Fukuchi. Genome and life-history evolution link bird diversification to the end-Cretaceous mass extinction. **Science Advances**, 31(10):eadp0114. ([pdf](/assets/docs/Berv_etal_2024.pdf) and [SI](/assets/docs/Berv_etal_2024_SI.pdf))
* Firneno, TJ, C Roelke, AD Leaché, N Rains, T Hibbitts, W Ryberg, T Laduc, S Singhal, and MK Fujita. Genome-wide data reinforces the evolutionary relationships of previously problematic earless lizards (Phyrnosomatidae: _Holbrookia_). **Bulletin of the Society of Systematic Biologists**, 3(2): 9459. ([pdf](/assets/docs/Firneno_etal_2024.pdf))
* Singhal S, HR Davis, JA Lemos-Espinal, MK Fujita, and AD Leaché. Comparative approaches to understanding speciation: a case study in Xantusia lizards. **Evolutionary Journal of the Linnean Society**, 3(1): kzae024. ([pdf](/assets/docs/Singhal_etal_Xantusia.pdf) and [SI](/assets/docs/Singhal_etal_Xantusia_SI.pdf) and [repo](https://github.com/singhal/xantusia))
